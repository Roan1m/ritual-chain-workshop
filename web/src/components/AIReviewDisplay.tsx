  ...
  return (
    <Card>
      <CardHeader
        ...
        action={
          parsed ? (
            <Badge tone="violet">Recommends #{parsed.winnerIndex}</Badge>
          ) : (
      ...
      <CardBody className="space-y-3">
        {parsed ? (
          <>
                    ...
                    {[...parsed.ranking]
                      ...
                      .map((r) => (
                        ...
                        >
                          ...
                          <td className="px-3 py-2 text-stone-300">{r.reason}</td>
                        </tr>
                      ))}
                  </tbody>
                </table>
            ...
            {parsed.summary && (
              <div className="rounded-xl bg-black/20 px-3 py-2 text-sm text-stone-200">
          ...
          <>
            ...
            <pre className="max-h-72 overflow-auto rounded-xl bg-black/40 p-3 font-mono text-xs text-stone-300 whitespace-pre-wrap break-words">
              {raw}
            </pre>
          </>
        )}
